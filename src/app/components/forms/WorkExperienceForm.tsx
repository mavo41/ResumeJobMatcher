...
import { BriefcaseBusiness, Eye, ChevronDown } from 'lucide-react';
...
const WorkExperienceForm: React.FC<WorkExperienceFormProps> = ({ data, onChange }) => {
  ...
  const addEntry = () => {
    onChange([...data, { company: '', jobTitle: '', startDate: '', endDate: '', city: '', description: '' }]);
  };
  ...
  return (
    <div className="mb-8">
      ...
      >
        <BriefcaseBusiness className="mr-2" /> Work Experience
